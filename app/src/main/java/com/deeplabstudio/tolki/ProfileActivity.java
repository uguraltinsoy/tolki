    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db.collection("Accounts").document(uid).get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
            ...
            public void onSuccess(DocumentSnapshot documentSnapshot) {
                ...
                mName.setText(name);
                if (image != null) Picasso.get().load(image).centerCrop().fit().into(mImage);
            }
        });

        findViewById(R.id.mSignOut).setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        findViewById(R.id.mSave).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ...
                }else Toast.makeText(ProfileActivity.this, "Lütfen adınızı giriniz", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        mImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (ContextCompat.checkSelfPermission(ProfileActivity.this, Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions(ProfileActivity.this,new String[]{Manifest.permission.READ_EXTERNAL_STORAGE},IMAGE);
                }
                else {
